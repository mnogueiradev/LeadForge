...
export const getActivityColorClass = (type: ActivityType | string) => {
  switch (type) {
    ...
    case 'message': return 'bg-emerald-100 text-emerald-600 dark:bg-emerald-900/40 dark:text-emerald-400 border-emerald-200 dark:border-emerald-800';
...
export const getActivityHexColor = (type: ActivityType | string) => {
  ...
  switch (type) {
    ...
    case 'message': return '#10b981'; // emerald-500
